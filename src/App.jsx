...
const VERBAL_POOL = [
  ...
  { type: "verbal", q: "Найдите лишнее: оферта, акцепт, индоссамент, тендер", options: ["Оферта", "Акцепт", "Индоссамент", "Тендер"], ans: 2 },
  ...
  { type: "verbal", q: "Найдите лишнее: DAP, EXW, FOB, EBITDA", options: ["DAP", "EXW", "EBITDA", "FOB"], ans: 2 },
  ...
  { type: "verbal", q: "Найдите лишнее: оферта, акцепт, нотариус, контракт", options: ["Оферта", "Акцепт", "Нотариус", "Контракт"], ans: 2 },
  ...
  { type: "verbal", q: "Найдите лишнее: тендер, аукцион, спецификация, котировка", options: ["Тендер", "Аукцион", "Спецификация", "Котировка"], ans: 2 },
