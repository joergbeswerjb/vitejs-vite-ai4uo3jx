...
const SITUATIONAL_POOL = [
  ...
  { type: "situational", q: "Поставщик сообщает что задержится с поставкой на 2 недели из-за проблем на производстве. Срок критичный. Что делаете первым делом?", options: ["Оцениваю критичность и параллельно ищу альтернативный источник", "Выставляю штраф согласно контракту и жду", "Сообщаю руководству и жду указаний", "Прошу поставщика ускориться и надеюсь на лучшее"], ans: 0 },
